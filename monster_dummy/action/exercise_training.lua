...
function exerciseTraining.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	local targetMonster = target:getName()

	if target:isItem() and (table.contains(HouseDummies, targetId) or table.contains(FreeDummies, targetId)) or target:isMonster() and (table.contains(MonsterDummies, targetMonster)) then
